...
for number in range(50):
    ...
    if number == search:
        print("found:", search)
        break  # If you dont add a break here, the "ELSE" evaluation will keep being executed for everey single loop and not at the end as a final command in case last resort.
else:
